...
options = {
  ...
  map_frame = "map",
  tracking_frame = "mobile_base_body_link",
...
--TRAJECTORY_BUILDER_2D.adaptive_voxel_filter.max_length = 0.8 --1.0 -- Increase --Default=0.9
--TRAJECTORY_BUILDER_2D.loop_closure_adaptive_voxel_filter.min_num_points = 350 --50 	-- Decrease --Default=100
